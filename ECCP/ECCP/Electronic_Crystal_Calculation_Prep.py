...
def ECCP(filepath, bonds_to_ignore=None, make_molecule_method='component_assembly_approach', molecule_equivalence_method={'method': 'invariance_method', 'type': 'combination'}, make_dimer_method={'method': 'nearest_atoms_method', 'max_dimer_distance': 8.0}, dimer_equivalence_method={'method': 'invariance_method', 'type': 'combination'}, environment_settings={'include_environment_in_molecule_calcs': False, 'include_environment_in_dimer_calcs': False, 'max_environment_distance': 8.0}, include_hydrogens_in_neighbour_analysis=False, include_hydrogens_in_uniqueness_analysis=False, remove_solvents=False, atc_file_creation_information=None, re_file_creation_information=None, fc_file_creation_information=None, eet_file_creation_information=None, ict_file_creation_information=None, overall_folder_suffix_name='', run_excited_state_from_optimised_ground_structure=False, no_of_cpus=1):
	"""
